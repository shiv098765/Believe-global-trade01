...
export default function AboutUs() {
  ...
  return (
    <section id="about" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-white overflow-x-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5 overflow-hidden">
        <div className="absolute top-0 left-0 w-64 h-64 sm:w-96 sm:h-96 bg-indigo-200 rounded-full filter blur-3xl" />
        <div className="absolute bottom-0 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-cyan-200 rounded-full filter blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 max-w-7xl">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 mb-4 sm:mb-6 bg-gradient-to-r from-indigo-100 to-cyan-100 rounded-full border border-indigo-200"
          >
            <Shield className="w-4 h-4 text-indigo-600" />
            <span className="text-indigo-600 text-xs sm:text-sm font-semibold">About Our Company</span>
          </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-16">
          ...
          >
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 flex items-center gap-2">
                <div className="w-1 h-6 sm:h-8 bg-gradient-to-b from-indigo-600 to-cyan-600" />
                Our Story
              </h3>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <motion.li
                    key={index}
                    variants={itemVariants}
                    className="flex items-start gap-3 p-2 sm:p-3 rounded-lg bg-gray-50 hover:bg-indigo-50 transition-colors"
                  >
            ...
            <motion.div
              variants={itemVariants}
              className="bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-white shadow-2xl"
            >
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                  <Phone className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="font-medium text-sm sm:text-base">+91 74055 62532</span>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="font-medium text-sm sm:text-base">believeglobaltrade@gmail.com</span>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="font-medium text-sm sm:text-base">Surat, India</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl group"
            >
              <img
            ...
            <motion.div
              variants={itemVariants}
              className="bg-gradient-to-br from-indigo-50 to-cyan-50 rounded-xl p-4 sm:p-6 border border-indigo-100"
            >
              <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-6">
            {values.map((value, index) => (
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{ y: -5 }}
                className="bg-white rounded-xl sm:rounded-xl p-8 sm:p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group"
              >
                <div className="w-32 h-32 sm:w-24 sm:h-24 bg-gradient-to-br from-indigo-50 to-cyan-50 rounded-full flex items-center justify-center mx-auto mb-6 sm:mb-6 group-hover:scale-110 transition-transform">
                  <value.icon className="w-16 h-16 sm:w-12 sm:h-12 text-indigo-600" />
                </div>
                <h4 className="text-lg sm:text-base font-bold text-gray-900 mb-2">
                  {value.title}
                </h4>
        ...
        >
          <div className="bg-gradient-to-r from-indigo-600 via-cyan-600 to-indigo-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden shadow-2xl">
            <div className="relative z-10">
              ...
              <motion.button
                ...
                className="bg-white text-indigo-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center gap-2 shadow-lg text-sm sm:text-base"
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-white/5 rounded-full" />
          </div>
        </motion.div>
      </div>
    </section>
